...
async function getBody(url) {
    var options = {
        ...
        'headers': {
            ...
            'accept-language': 'ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7,ro;q=0.6,de;q=0.5',
        }
    };
    ...
    return new Promise((resolve, reject) => {
        ...
        try {
            ...
            radioStationList.map((station) => {
                // let station = {}
                let stationTitle = station.querySelector('.station__title__name').rawText
                ...
                parsedStations.push({ stationTitle, stationImg, stationListeners, stationIP })
...
module.exports = async function urlParser(url) {
    ...
    /*  {
    stationTitle: 'Radio Bucovina',
    stationImg: '//cdn.onlineradiobox.com/img/logo/2/64502.v6.png',
    statonListeners: '1'
},
